...
describe('AddLabelToCard Use case', () => {
  it('should add the label to the card and to the board if no id is passed', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      const boardAggregateRepository =
        new BoardAggregateRepositoryBuilder_1.BoardAggregateRepositoryBuilder()
  ...
  it('should add the label to the card and not to the board if an id is passed', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      // Given
      let aggregateExpected = null;
      const aggregate = new src_1.BoardAggregateBuilder()
      ...
      // When
      const { name } = request,
        requestRest = __rest(request, ['name']); // remove the name
      yield useCase.execute(
        Object.assign(Object.assign({}, requestRest), { labelId: labelID }),
        presenter
      );
      // Then
      expect(presenter.response).not.toBe(null);
  ...
  it('should not add a label twice to the card', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      // Given
      let aggregateExpected = null;
      const label = {
      ...
      // When
      yield useCase.execute(
        Object.assign(Object.assign({}, request), { labelId: labelID }),
        presenter
      );
      // Then
      expect(presenter.response).not.toBe(null);
  ...
  it('should show error if the label does not exist', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      var _a;
      // Given
      let aggregateExpected = null;
      ...
      expect(
        (_a = presenter.response.errors) === null || _a === void 0
          ? void 0
          : _a.labelId
      ).toHaveLength(1);
    }));
  it('should show error if the card does not exist', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      var _b;
      // Given
      let aggregateExpected = null;
      ...
      expect(aggregateExpected).toBeNull();
      expect(
        (_b = presenter.response.errors) === null || _b === void 0
          ? void 0
          : _b.cardId
      ).toHaveLength(1);
    }));
  it('should show error if the board does not exist', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      var _c;
      // Given
      let aggregateExpected = null;
      ...
      expect(aggregateExpected).toBeNull();
      expect(
        (_c = presenter.response.errors) === null || _c === void 0
          ? void 0
          : _c.boardId
      ).toHaveLength(1);
    }));
  it('show error if the requester is not a member of the board', () =>
    __awaiter(void 0, void 0, void 0, function* () {
      var _d;
      // Given
      let aggregateExpected = null;
      ...
      expect(aggregateExpected).toBeNull();
      expect(
        (_d = presenter.response.errors) === null || _d === void 0
          ? void 0
          : _d.requestedBy
      ).toHaveLength(1);
    }));
        ...
        __awaiter(void 0, void 0, void 0, function* () {
          ...
          const boardAggregateRepository =
            new BoardAggregateRepositoryBuilder_1.BoardAggregateRepositoryBuilder()
              ...
              .build();
          const useCase = new src_1.AddLabelToCardUseCase(
